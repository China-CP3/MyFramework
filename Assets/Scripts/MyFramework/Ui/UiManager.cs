...
public class UiManager : Singleton<UiManager>
{
    ...
    public UiManager()
    {
        ...
        canvas = ResourcesManager.Instance.Load<GameObject>("Ui/Prefabs/Canvas").transform as RectTransform;
        eventSystem = ResourcesManager.Instance.Load<GameObject>("Ui/Prefabs/EventSystem");
    ...
    public void ShowPanel<T>(string panelName, E_Ui_Layer ui_Layer = E_Ui_Layer.Bottom, UnityAction<T> callBack = null) where T : BasePanel
    {
        ...
        ResourcesManager.Instance.LoadAsync<GameObject>("Ui/Prefabs/" + panelName, (panel) =>
        {
            switch (ui_Layer)
            {
